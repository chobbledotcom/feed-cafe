...
name: About
permalink: /about/
meta_title: About Feed Cafe & Deli | St Ives
meta_description: Learn about Feed Cafe & Deli, a St Ives cafe serving breakfast, coffee, sandwiches, burgers, loaded fries, bowls and cakes.
eleventyNavigation:
  key: About
  order: 4
blocks:
  - type: image-background
    ...
    image_alt: Feed Cafe counter with timber slats and green panelling
    tint: true
    content: |
      # About Feed
  ...
  - type: stats
    items:
      - "2020|Est. On The Logo"
      - "11.30am|Breakfast Served Until"
      - "St Ives|Cafe & Deli"
      - "Good Food|Good Coffee"

  - type: split-image
    subtitle: What is on the board
    content: |
